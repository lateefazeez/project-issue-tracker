  ...
  return (
    <Fragment>
      <TableContainer
        style={{
          overflow: "hidden",
          borderTop: "0.2px solid rgb(112, 112, 112)",
          borderLeft: "0.2px solid rgb(112, 112, 112)",
          borderRight: "0.2px solid rgb(112, 112, 112)",
              ...
              projects
                ...
                .map((project, index) => (
                  ...
                  >
                    ...
                    <TableCell
                      onClick={() =>
                        navigate("/tickets", { state: { id: project.id } })
                      }
                    >
                      {project.description}
                    </TableCell>
                    ...
                    >
                      <ProgressBar
                        ...
                        height="20px"
                        color={getProjectStatus(project).barColor}
                        percent={getProjectPercentComplete(data, project.id)}
                      />
                    </TableCell>
                    <TableCell
                      onClick={() =>
