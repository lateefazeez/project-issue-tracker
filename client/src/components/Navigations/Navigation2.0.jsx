    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <div className="user">
          ...
          {loggedInUser ? (
            <h3 className="logged-user">{loggedInUser.name}</h3>
          ) : (
            <h3 className="logged-user">{userNameFromSession}</h3>
          )}
        </div>
        <hr className="divider"></hr>
        <List className="navitems">
          {[
            <Link to="/navigation">Dashboard</Link>,
            "My account",
            "My issues",
            "Chat",
            "Board",
            ...
            <ListItem button key={text} style={{ color: "#BCBABA" }}>
              <ListItemIcon>
                {index % 2 === 0 ? (
                  <DashboardIcon style={{ color: "#BCBABA" }} />
                ) : (
                  <FormatListBulletedIcon style={{ color: "#BCBABA" }} />
                )}
              </ListItemIcon>
